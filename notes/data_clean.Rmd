...
am_included <- names(ast_ecoli_cleaned[, c(5:length(ast_ecoli_cleaned))])
...
eucast_am_bp <- match(bp_ec_eucast$antimicrobial, names(ast_ecoli_cleaned))
eucast_am_bp <- eucast_am_bp[!is.na(eucast_am_bp)]

clsi_am_bp <- match(bp_ec_clsi$antimicrobial, names(ast_ecoli_cleaned))
clsi_am_bp <- clsi_am_bp[!is.na(clsi_am_bp)]
